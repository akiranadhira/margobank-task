...
import com.margobank.transaction.dto.ErrorResponseDto;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleAccountDoesNotExistException(
            AccountDoesNotExistException exception, WebRequest webRequest) {
    ...
    public ResponseEntity<ErrorResponseDto> handleConcurrentUpdateException(
